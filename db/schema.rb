...
ActiveRecord::Schema.define(version: 2021_05_05_185232) do
  ...
  create_table "subscribes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["subscribee_id", "subscriber_id"], name: "index_subscribes_on_subscribee_id_and_subscriber_id", unique: true
